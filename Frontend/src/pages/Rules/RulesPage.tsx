        ...
        <div class="max-w-4xl mx-auto space-y-8">
          ...
          Names/Miis
              ...
              to worldwides):
                        ...
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300 ml-6 transition-colors">
              ...
              rooms):
                  ...
                  discretion
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 transition-colors">
          ...
          Cheating/Hacking/Bug Abusing
                ...
                <ul class="space-y-3 text-gray-600 dark:text-gray-300 transition-colors">
                    <li class="flex items-start">
                        <span class="text-red-500 mr-2 mt-1">•</span>
                        <span>
          ...
          Trolling/Targeting
                ...
                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-4 transition-colors">
                    <p class="text-green-800 dark:text-green-200 transition-colors">
          ...
          Emulator Lag/Speed Up
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 italic mb-4 transition-colors">
          ...
          to speed up
              ...
              to do so
                ...
                <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mt-4 transition-colors">
                    <p class="text-red-800 dark:text-red-200 transition-colors">
          ...
          violating the rules, the ban lengths mentioned above can be bypassed.
            ...
            <div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-6 transition-colors">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-purple-900 dark:text-purple-100 mb-3 transition-colors">
              Appealing
                        </h2>
                        <p class="text-purple-800 dark:text-purple-200 mb-4 transition-colors">
