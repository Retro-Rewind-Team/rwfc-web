    ...
    return (
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <div class="text-center">
                <div class="py-4">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-400">
                        Please read and follow these rules to ensure a fair and enjoyable experience
                        for everyone
                    </p>
                </div>
            </div>
            ...
            <AlertBox type="info" title="Important Notice">
                <p>
                    Punishments are handled on a case-by-case basis, and may differ in lengths if
                    judged necessary by RWFC staff. This rule can be enforced more strictly during
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Names/Miis</h2>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-3">
                            Any political figure, light profanity, common drugs, suggestive content,
                            etc. will result in the following lengths (only applies to worldwides):
                        </p>
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-3">
                            Extreme political views, hate speech, slurs, etc. will result in the
                            following ban lengths (applies to ALL rooms, including private rooms):
                        </p>
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300 ml-6">
                            <li class="flex items-start">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                        <p class="text-gray-700 dark:text-gray-300">
                            <strong>Note:</strong> If a RWFC Staff member thinks that your name/Mii
                            is in violation of the rules that aren't mentioned above, they can
                            kick/ban you with or without a warning.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <ul class="space-y-3 text-gray-600 dark:text-gray-300">
                    ...
                    <li class="flex items-start">
                        <span class="text-red-600 mr-2 mt-1">•</span>
                        <span>
                            <strong>Ban evasion:</strong> Will result in a permanent ban for the
                            evasion as well as the main profile
                        </span>
                    </li>
                    <li class="flex items-start">
                        <span class="text-red-600 mr-2 mt-1">•</span>
                        <span>
                            <strong>Rage cheating:</strong> Mass item cheats, room crashers, etc.
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 italic mb-4">
                    Moving up spots due to FPS, teleporting around, moving down spots due to speed
                    up
                </p>
                ...
                <ul class="space-y-3 text-gray-600 dark:text-gray-300">
                    <li class="flex items-start">
                        ...
                        <span>
                            ...
                            enough time to check their settings then get back on if they wish to do
                            so
                        </span>
                    </li>
                    <li class="flex items-start">
                ...
                <div class="mt-4">
                    <AlertBox type="error">
                        <p>
                            <strong>Intentional lag/speed up:</strong> If it is discovered that a
                            player is lagging/speeding up their game on purpose, the bans will
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    <strong>10 minute ban</strong> so the issue(s) can be fixed. Ban lifted early
                    once fixed.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    If RWFC Staff thinks a player has suspicious activity (playing with cheat codes,
                    potentially ban evading, etc.) they can kick/ban you with or without a warning.
                    This rule can be enforced more strictly during peak hours or when a content
                    creator is present.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    If RWFC Staff thinks a player joined with the sole purpose of violating the
                    rules, the ban lengths mentioned above can be bypassed.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    In rare cases, rule violations on Retro WFC may result in sanctions on the
                    ...
                    also lead to corresponding action on Retro WFC.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    To avoid disrupting competitive leagues on Retro WFC, staff will generally delay
                    penalties for rule violations that occur during matches until play concludes.
                    However, in severe cases, staff may impose immediate penalties, including
                    temporary removal or bans, during matches.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-3">
                    If a player is suspected of adding VR with external tools or getting impossible
                    gains, they will be marked as suspicious on the VR leaderboard. Heavily abusing
                    disconnects to gain VR or not lose VR will also be considered VR manipulation
            ...
            <AlertBox type="info" icon={<Scale size={20} />} title="Appealing">
                <p class="mb-4">
                    If you think you were unfairly banned or the length of your ban is not
                    justified, you can always appeal it on the Retro Rewind Discord by creating a
                    ticket.
                </p>
                <a
