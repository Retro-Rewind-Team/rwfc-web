...
export default function RulesPage() {
    return (
        <div class="max-w-4xl mx-auto space-y-8">
          ...
          lengths if judged necessary by RWFC staff. This rule can be enforced
          more strictly during peak hours or when a content creator is present.
                </p>
            </AlertBox>
          ...
          Trolling/Targeting
            ...
            troll/target players. Playing like a douchebag is allowed as long as
            you prioritize actually racing. Playing with the sole intent to
            troll/disrupt is unwanted and
          ...
          to speed up
              ...
              to do so
                ...
                <div class="mt-4">
                    <AlertBox type="error">
                        <p>
                            <strong>Intentional lag/speed up:</strong> If it is discovered
              that a player is lagging/speeding up their game on purpose, the
              bans will result in being 3 days → 7 days → 30 days.
                        </p>
                    </AlertBox>
                </div>
            </div>
          ...
          will also be considered VR manipulation and will be flagged by staff.
                ...
                <p class="text-gray-600 dark:text-gray-300">
          Leaderboard flags can be appealed through a ticket just like bans can.
          Flags can be lifted, on staff discretion, by either reverting the
          illegitimate VR gains or, especially in case of general VR
          ...
          justified, you can always appeal it on the Retro Rewind Discord by
          creating a ticket.
                </p>
                <a
