...
const resourceCards = [
    ...
    },
    {
        ...
        description: () => "Complete wiki with features, troubleshooting, and version history",
        ...
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <AlertBox type="info" title={`Retro Rewind v${v()?.version ?? "..."}`}>
                <p class="text-lg mb-4">
                    Complete distribution with {retroTrackCount() ?? "..."} retro tracks and{" "}
                    {customTrackCount() ?? "..."} custom tracks
                </p>
            ...
            <AlertBox type="warning" title="Important Notes">
                <div class="space-y-2 text-sm">
                    <p>
                        <strong>Do NOT use Wiimmfi-patched games</strong> - Retro Rewind uses Retro
                        WFC servers
                    </p>
                    <p>
                        <strong>Disable all cheat codes</strong> - Any active cheats will prevent
                        online play
                    </p>
                    <p>
                        <strong>Console users:</strong> Extract to SD card root and replace existing
                        files, don't delete any files!
                    </p>
                    <p>
                        <strong>Dolphin users:</strong> Use Wheel Wizard for easiest setup, disable
                        "Enable Cheats"
                    </p>
                </div>
            </AlertBox>
            ...
            <AlertBox type="info" title="Need Help?">
                <p class="mb-3 text-sm">
                    Having trouble with installation or experiencing issues? The Retro Rewind
                    community is very active and helpful! Join our Discord server for real-time
                    support, or check the comprehensive wiki for detailed documentation.
                </p>
                <div class="flex flex-col sm:flex-row gap-3">
                    <a
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6 text-sm">
                    These custom track distributions also use Retro WFC servers, make sure to check
                    them out!
                </p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
