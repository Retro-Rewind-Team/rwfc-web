...
const resourceCards = [
    ...
    },
    {
        ...
        description: () => "Rank calculator, save file editor, font patcher, and more community-made tools",
        href: "/tools",
        label: "Browse Tools",
        external: false,
    },
    ...
    return (
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        { name: "Wack Track Pack", videoId: "SaqpXDXpydE", discord: "https://discord.com/invite/XB6YmGhyNA", thumb: "maxresdefault" },
                        { name: "OptPack", videoId: "FYk-CdbDrok", discord: "https://discord.gg/37p93TtZHZ", thumb: "hqdefault", thumbDomain: "i.ytimg.com" },
                        { name: "Luminous", videoId: "lJXAeXQb0Bc", discord: "https://discord.gg/ZCuny29DQk", thumb: "maxresdefault" },
                    ].map((pack) => (
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
                            <a href={`https://www.youtube.com/watch?v=${pack.videoId}`} target="_blank" rel="noopener noreferrer">
                                <img
                                    src={pack.thumbDomain
