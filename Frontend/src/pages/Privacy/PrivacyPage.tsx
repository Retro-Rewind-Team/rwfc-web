    ...
    return (
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <AlertBox type="info" title="Important Notice">
                <p>
                    We reserve the right to change this policy at any given time, of which you will
                    be notified via our Discord announcements and the Message of the Day upon
                    logging in.
                </p>
            </AlertBox>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-3">
                            While playing on RWFC, we collect a few identifiers from your Console to
                        ...
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300 ml-6">
                            ...
                            <li class="flex items-start">
                                <span class="text-blue-600 mr-2 mt-1">•</span>
                                Your Mii, which may contain the name you have set in your console
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-3">
                            Moderators may access all data collected while playing on RWFC via the
                            Retro WFC Bot.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-3">
                            We do not share data with any third-parties, however some information
                            may be shared via Discord in private channels or DMs and over Discord's
                            bot platform.
                        </p>
                    </div>
                </div>
