                                    ...
                                    return (
                                        <div class="w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] xl:w-[calc(25%-1.125rem)] group relative">
                                            ...
                                            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl p-6 transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                                                ...
                                                {/* Discord Username */}
                                                <div class="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400 font-mono bg-gray-50 dark:bg-gray-700/50 py-2 px-3 rounded-lg transition-colors border border-gray-200 dark:border-gray-600 mb-3">
                                                    <svg
                                                ...
                                                {/* Friend Code */}
                                                {member.fc && (
                                                    <div class="flex items-center justify-center gap-2 text-xs text-blue-700 dark:text-blue-300 mb-4 font-mono bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 py-2 px-3 rounded-lg transition-colors border border-blue-200 dark:border-blue-700">
                                                        <svg
