...
import { badgeInfo, type BadgeType } from "../../utils/badgeData";
            ...
            <svg viewBox="0 0 16 16" class="w-full h-full drop-shadow-xl">
                <defs>
                    ...
                    >
                        <stop
                            offset="0%"
                            style={`stop-color:${colors.outer[0]};stop-opacity:1`}
                        />
                        <stop
                            offset="50%"
                            style={`stop-color:${colors.outer[1]};stop-opacity:1`}
                        />
                        <stop
                            offset="100%"
                            style={`stop-color:${colors.outer[2]};stop-opacity:1`}
                        />
                    </linearGradient>
                </defs>
