...
export default function TTWRHistory(props: TTWRHistoryProps) {
            ...
            <Show when={props.history && !props.isLoading}>
                ...
                >
                    <div class="p-6">
                        <div class="relative">
                            {/* Timeline Line */}
                            <div class="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-amber-400 via-orange-500 to-red-600"></div>
                                    ...
                                    {(record, index) => {
                                        ...
                                        return (
                                            <div class="relative pl-16">
                                                {/* Timeline Dot */}
                                                <div
                                                    class={`absolute left-6 top-3 w-5 h-5 rounded-full border-4 ${
                                                        isLatest
                                                ...
                                                {/* Record Card */}
                                                <div
                                                    class={`bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border-2 transition-all hover:shadow-lg ${
                                                        isLatest
    ...
    Player
                        ...
                        <Show when={props.history!.length > 1}>
                            <div class="mt-8 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
